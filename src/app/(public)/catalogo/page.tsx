...
export const metadata: Metadata = {
  ...
  description:
    "Explora nuestros productos para mascotas y jardinería. Filtra por categorías y encuentra calidad al mejor precio.",
  openGraph: {
    title: `Catálogo | ${TENANT_CONFIG.name}`,
    ...
    <div className="min-h-[100dvh] pt-24 pb-20 px-4 md:px-6 max-w-7xl mx-auto flex flex-col relative">
      ...
      <header className="mb-10 text-center md:text-left relative z-10">
        ...
        <p className="text-muted-foreground text-lg font-medium max-w-2xl">
          Encontrá todo lo que buscás al mejor precio del mercado. Buscá por
          nombre o filtrá por categorías.
        </p>
      </header>
