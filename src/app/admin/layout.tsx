...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-[100dvh] flex bg-[#F8FAFC] font-sans relative">
      ...
      {/* Sidebar */}
      <aside
        className={`w-[280px] bg-white shadow-[10px_0_40px_rgba(0,0,0,0.03)] border-r border-gray-100 p-6 flex flex-col fixed inset-y-0 left-0 z-[70] transition-transform duration-300 ease-out ${
      ...
      >
        ...
        <nav className="flex flex-col gap-2 flex-grow">
          <a
            href="/admin"
            onClick={() => setIsSidebarOpen(false)}
            className="px-5 py-4 md:py-3.5 text-sm rounded-2xl text-gray-500 hover:text-primary hover:bg-primary/5 transition-all font-bold flex items-center gap-3"
          >
