    ...
    <div className="max-w-6xl animate-in fade-in duration-500 pb-20">
      ...
      <div className="bg-gradient-to-br from-primary via-[#0284c7] to-[#0ea5e9] rounded-[2rem] p-8 md:p-12 mb-10 relative overflow-hidden flex flex-col md:flex-row items-center justify-between shadow-[0_20px_60px_-15px_rgba(14,165,233,0.4)]">
        ...
        <div className="z-10 text-white md:w-2/3">
          <h1 className="text-3xl md:text-4xl font-black font-heading tracking-tight mb-3">
            Panel de Control General
          </h1>
          <p className="text-white/70 font-medium text-lg leading-relaxed max-w-xl">
            Gestioná tu inventario en tiempo real, generá presupuestos al
            instante y mantené actualizado todo tu catálogo comercial desde un
            solo lugar.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center p-6 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm z-10 w-full md:w-48 mt-8 md:mt-0">
          <span className="text-white/50 text-xs font-black uppercase tracking-widest mb-1">
            Total Catálogo
          </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Link
          ...
          className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 flex flex-col group hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-500/5 hover:border-blue-100 transition-all duration-300"
        >
          ...
          <h2 className="text-xl font-black font-heading tracking-tight mb-2 text-foreground group-hover:text-blue-600 transition-colors">
            Gestión de Productos
          </h2>
          <p className="text-sm font-medium text-gray-500 mb-8 flex-grow leading-relaxed">
            Administrá tu catálogo: precios, stock, imágenes y organización de
            productos.
          </p>
        ...
        <Link
          ...
          className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 flex flex-col group hover:-translate-y-1 hover:shadow-xl hover:shadow-emerald-500/5 hover:border-emerald-100 transition-all duration-300"
        >
          ...
          <h2 className="text-xl font-black font-heading tracking-tight mb-2 text-foreground group-hover:text-emerald-600 transition-colors">
            Generador de Presupuestos
          </h2>
          <p className="text-sm font-medium text-gray-500 mb-8 flex-grow leading-relaxed">
            Creá presupuestos rápidamente y enviá cotizaciones listas para tus
            clientes.
          </p>
