export const TENANT_CONFIG = {
  ...
  commercialMessage: "Hola, estuve viendo su catálogo online y me interesa consultar por algunos productos.",
  budgetMessage: "Hola, le comparto el presupuesto solicitado.",
  seo: {
    title: "Distribuidora Manitos | Todo para Mascotas y Jardinería",
    description: "En Distribuidora Manitos vas a encontrar el mejor catálogo mayorista y minorista de productos para mascotas.",
